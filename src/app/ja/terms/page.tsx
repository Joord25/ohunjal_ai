...
第13条（知的財産権および利用制限）
本サービスに関するすべての知的財産権（AIアルゴリズム、トレーニングプラン、UIデザイン、コンテンツを含む）は当社に帰属します。会員は当社の書面による事前同意なく、サービスコンテンツを複製、修正、配布、商業利用することはできません。

第14条（サービス利用制限およびアカウント停止）
当社は以下の場合、会員のアカウントを制限または停止することがあります：本規約違反、サービス運営妨害、なりすまし、虚偽情報の流布、その他会員のサービス利用を脅かす行為。緊急の場合を除き、事前に通知します。

第15条（サービスの解約および退会）
会員はいつでもアカウント削除機能を通じて契約を解約し、退会することができます。退会時の個人情報はプライバシーポリシーに従って処理され、法令で定める保管期間経過後に破棄されます。

第16条（準拠法および管轄）
本サービスに関する紛争は大韓民国法に準拠し、当社の登録住所地を管轄する裁判所を専属的合意管轄とします。当社と会員間の紛争は韓国消費者院にも調停を申請できます。

第17条（分離条項）
本規約の一部が関係法令により無効または執行不能と判断された場合でも、残りの条項の効力には影響しません。
