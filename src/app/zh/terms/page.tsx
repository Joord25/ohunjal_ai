...
第13条（知识产权及使用限制）
与服务相关的所有知识产权（包括AI算法、训练计划、UI设计和内容）归公司所有。未经公司书面事先同意，会员不得复制、修改、分发或商业利用任何服务内容。

第14条（服务限制及账号停用）
在以下情况下，公司可能限制或停用会员账号：违反本条款、干扰服务运营、冒用他人身份、传播虚假信息或其他威胁其他会员使用服务的行为。除紧急情况外，公司将提前通知。

第15条（服务终止及退出）
会员可随时通过账号注销功能终止协议并退出服务。退出时的个人信息按隐私政策处理，法律规定的保留期限届满后销毁。

第16条（管辖法律及争议解决）
与服务相关的争议适用大韩民国法律，由公司注册地址所在地法院管辖。公司与会员之间的争议也可向韩国消费者院申请调解。

第17条（可分割性）
如本条款的任何条款被认定为无效或不可执行，其余条款的效力不受影响。
