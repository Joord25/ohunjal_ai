              ...
              <div className="space-y-3 text-[13px] text-gray-600 leading-relaxed">
                ...
                <div className="bg-gray-50 rounded-xl p-3 space-y-2">
                  ...
                  <div className="space-y-1.5 text-[12px]">
                    ...
                    <p>{locale === "ko" ? "3. 6개 카테고리(가슴/등/어깨/하체/코어 & 팔/체력) 가중 평균" : "3. Weighted average of 6 categories (chest/back/shoulder/legs/core & arms/cardio)"}</p>
                ...
                <div className="bg-gray-50 rounded-xl p-3 space-y-2">
                  ...
                  <div className="space-y-1 text-[12px]">
                    ...
                    <div className="flex justify-between"><span>{locale === "ko" ? "코어 & 팔" : "Core & Arms"}</span><span className="font-bold">12%</span></div>
                  </div>
                </div>
                <div className="bg-gray-50 rounded-xl p-3 space-y-2">
              ...
              <div className="space-y-3 text-[13px] text-gray-600 leading-relaxed">
                ...
                <div className="bg-gray-50 rounded-xl p-3 space-y-2">
                  ...
                  <div className="space-y-1.5 text-[12px]">
                    ...
                    <p>{locale === "ko" ? "종합 = 6개 카테고리의 가중 평균 (하체25/가슴18/등18/체력15/어깨12/코어&팔12)" : "Overall = weighted avg of 6 categories (legs25/chest18/back18/cardio15/shoulder12/core&arms12)"}</p>
                  </div>
                </div>
                <div className="bg-gray-50 rounded-xl p-3 space-y-2">
