            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 20, alignItems: "center", textAlign: "center", width: "100%" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 16, alignItems: "center" }}>
                ...
                <div style={{ textAlign: "center" }}>
                  ...
                  <p style={{ color: "white", fontSize: 52, fontWeight: 400, lineHeight: 1, textShadow: shadow, letterSpacing: "-0.02em", fontFamily: "var(--font-questrial), -apple-system, BlinkMacSystemFont, sans-serif", WebkitTextStroke: "0.6px white" }}>
                    {formatRunDistanceKm(runningStats?.distance)}
                    <span style={{ fontSize: 20, color: "white", marginLeft: 5, fontWeight: 400, letterSpacing: "-0.01em", fontFamily: "var(--font-questrial), -apple-system, BlinkMacSystemFont, sans-serif", WebkitTextStroke: "0.4px white" }}>{t("share.running.unitKm")}</span>
                  </p>
                </div>
                ...
                <div style={{ textAlign: "center" }}>
                  ...
                  <p style={{ color: "white", fontSize: 52, fontWeight: 400, lineHeight: 1, textShadow: shadow, letterSpacing: "-0.02em", fontFamily: "var(--font-questrial), -apple-system, BlinkMacSystemFont, sans-serif", WebkitTextStroke: "0.6px white" }}>
                    ...
                    <span style={{ fontSize: 20, color: "white", marginLeft: 5, fontWeight: 400, letterSpacing: "-0.01em", fontFamily: "var(--font-questrial), -apple-system, BlinkMacSystemFont, sans-serif", WebkitTextStroke: "0.4px white" }}>{t("share.running.unitPerKm")}</span>
                  </p>
                </div>
