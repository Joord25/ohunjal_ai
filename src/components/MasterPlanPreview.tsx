...
export const MasterPlanPreview: React.FC<MasterPlanPreviewProps> = ({
  ...
  return (
    <div ref={containerRef} className="flex flex-col h-full bg-[#FAFBF9] animate-fade-in relative overflow-hidden">
      ...
      {/* Bottom CTA */}
      <div className="absolute bottom-0 left-0 right-0 px-5 pt-8 bg-gradient-to-t from-[#FAFBF9] via-[#FAFBF9] to-transparent z-20" style={{ paddingBottom: "calc(var(--safe-area-bottom, 0px) + 60px)" }}>
